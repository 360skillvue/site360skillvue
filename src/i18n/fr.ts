  ...
  tarifs: {
    ...
    rps: {
      ...
      features: [
        ...
        'Indicateurs agrégés anonymisés pour l\'employeur',
        'Téléconsultation d\'orientation de 30 min (collaborateurs détectés positifs)',
        'Plan d\'action de prévention : cartographie anonymisée, priorisation',
    ...
    tms: {
      ...
      features: [
        ...
        'Coaching vidéo personnalisé (gestes et postures) pour chaque collaborateur à risque',
        'Étude de poste exhaustive par un ergonome IPRP',
        'Rapport complet — tous les collaborateurs du poste analysés',
        'Plan d\'action de prévention TMS et restitution direction (offerts dès 10 études)',
      ],
