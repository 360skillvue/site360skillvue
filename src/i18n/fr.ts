export const fr = {
  ...
  home: {
    ...
    videosSubtitle: 'Le dépistage des risques psychosociaux et le dépistage des TMS, écran par écran, en version française et en version suisse. Chaque salarié est analysé individuellement par un expert ; l\'employeur ne reçoit jamais les réponses individuelles, seulement une vision collective et un plan d\'action.',
    videosFrLabel: 'Version France',
    videosChLabel: 'Version Suisse',
    videosRpsFr: 'RPS, France',
    videosRpsCh: 'RPS, Suisse',
    videosTmsFr: 'TMS, France',
    videosTmsCh: 'TMS, Suisse',
  ...
  tarifs: {
    ...
    tms: {
      ...
      plans: [
        ...
        },
        {
          ...
          items: [
            ...
            'Étude de situation de travail complète et rapport individuel en option, 250 € HT par salarié repéré',
        ...
        },
        {
          ...
          items: [
            'Tout le Pack Premium',
            'Étude de situation de travail complète et rapport individuel pour les salariés repérés, dans la limite d\'un plafond indexé sur votre secteur, de 5 à 40 % de l\'effectif',
      ...
      features: [
        ...
        'Étude de situation de travail complète par un ergonome',
    ...
    tableTarif: 'Tarif',
    autonomyNote: 'Vous disposez de vos propres experts (service de prévention, ergonome ou psychologue du travail) ? Une formule en autonomie existe — contactez-nous.',
    faqTitle: 'Questions fréquentes',
    faqs: [
      { q: 'Qu\'est-ce que ScanUp RPS et TMS ?', a: 'Des modules d\'évaluation scientifiquement validés pour dépister les Risques Psycho-Sociaux et les Troubles Musculo-Squelettiques au sein de vos équipes. Résultats en 48 h.' },
  ...
  spsti: {
    ...
    cadre: [
      ...
      },
      {
        ...
        scanup: 'ScanUp lui apporte les deux : le repérage individuel des salariés concernés, et l\'étude de situation de travail qui porte les préconisations d\'aménagement.',
      },
      {
    ...
    tracaItems: [
      ...
      'Les études de situation de travail réalisées et les préconisations d\'aménagement remises',
