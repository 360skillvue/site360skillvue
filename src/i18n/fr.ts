export const fr = {
  ...
  entreprises: {
    ...
    problems: [
      ...
      { n: '03', title: 'Coût prohibitif de la prévention', body: 'Un audit RPS coûte 15 000 €. L\'inaction coûte encore plus : 1 à 2 fois le salaire annuel par départ.', stat: 'dès 27 € avec ScanUp' },
